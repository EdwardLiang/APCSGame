...
public class DevModeKeys extends DefaultKeys {
		...
		public synchronized void handle(KeyEvent key) {
			...
			try {
				...
				if (t.getCode() == KeyCode.O) {
					System.out.println(GameWorld.world.getCurrentMap());
				}
				if (t.getCode() == KeyCode.U) {
					System.out.println(GameWorld.world.getCurrentMap());
					// System.out.println(GameMap.parse(GameWorld.world.getCurrentMap()
					// .toString(), "asdf"));
